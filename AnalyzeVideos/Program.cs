...
namespace AnalyzeVideos
{
    public class Program
    {
        ...
        private static string InputMP4FileName= @"InputVideo.mp4";
            ...
            string outputFolderName)
        {
            ...
            string directory = Path.Combine(outputFolderName);
            ...
            do
            {
                ...
                foreach (IListBlobItem blobItem in segment.Results)
                {
                    ...
                    if (blob != null && blob.Name=="insights.json")
                    {
        ...
        public static string FetchData()
        {
            ...
            string jsonFile = @"Output\insights.json";
            ...
            try
            {
                ...
                if (jObject != null)
                {
                    JArray transcriptArrary = (JArray)jObject["transcript"];
                    if (transcriptArrary != null)
                    {
                        foreach (var item in transcriptArrary)
                        {
                            string i = item["text"].ToString();
                            fdList.Add(i);
                        }
            ...
            string conCat = string.Join(" ", fdList.ToArray());
            return conCat;
        }
    }
}
